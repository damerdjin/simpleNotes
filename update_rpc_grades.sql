-- Mettez à jour la fonction RPC get_student_visible_grades pour inclure:
-- 1. Le commentaire du professeur
-- 2. La moyenne de la classe
-- 3. La note la plus haute de la classe
-- 4. La note la plus basse de la classe
