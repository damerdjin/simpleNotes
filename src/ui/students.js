...
(function () {
    ...
    <div class="student-item group relative bg-white p-4 sm:p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 flex items-center gap-4">
        ...
        <div class="student-info min-w-0 flex-1">
            ...
            <div class="flex flex-row flex-nowrap items-center gap-2 mt-3 sm:hidden w-full">
                <button onclick="viewStudentGrades('${s.id}')" class="flex-1 inline-flex flex-row flex-nowrap items-center justify-center gap-1.5 py-2 bg-blue-600 text-white rounded-xl text-[11px] font-bold shadow-sm active:scale-95 transition-all whitespace-nowrap overflow-hidden">
                    <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    <span class="truncate leading-none">${t.viewGradesShort || 'Notes'}</span>
                </button>
                <button onclick="openStudentModal('${s.id}')" class="w-10 h-10 flex items-center justify-center bg-slate-100 text-slate-600 rounded-xl active:scale-90 transition-all shrink-0 border border-slate-200">
